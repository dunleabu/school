...
type Class comparable_question msg
    = Class
        ...
        , view : comparable_question -> Convert msg -> Qhtml msg
...
updateRow : Class comparable_q m -> Msg m -> Row comparable_q -> Row comparable_q
...
viewRow : Class comparable_q m -> Row comparable_q -> Html (Msg m)
viewRow (Class c) r =
    let
        h : Qhtml m
